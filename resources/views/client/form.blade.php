    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <div>
                    {{ Form::text('customer_name', $client->customer_name, ['class' => 'form-control texto' .
        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <div>
                    {{ Form::text('yacht_name', $client->yacht_name, ['class' => 'form-control texto' .
        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <div>
                    {{ Form::text('location', $client->location, ['class' => 'form-control texto' .
        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <div>
                    {{ Form::text('phone', $client->phone, ['class' => 'form-control texto' .
        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <div>
                    {{ Form::text('email', $client->email, ['class' => 'form-control texto' .
