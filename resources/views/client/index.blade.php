        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('clients.create') }}" class="btn btn-primary d-none d-sm-inline-block texto">
                        ...
                        <a href="{{ route('clients.create') }}" class="btn btn-primary d-sm-none btn-icon">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body border-bottom py-3 table-responsive">
                            <table style="margin-top: 55px;" id="search-clients" class="table table-vcenter datatable">
                                <thead>
                                <tr>
                                    <th class="w-1"><a class="table-header">No.</a></th>
										...
										<th><a class="table-header">Phone</a></th>
