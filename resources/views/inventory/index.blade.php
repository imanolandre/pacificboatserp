...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('inventory.create') }}" class="btn btn-primary d-none d-sm-inline-block texto">
                        ...
                        <a href="{{ route('inventory.create') }}" class="btn btn-primary d-sm-none btn-icon">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body border-bottom py-3 table-responsive">
                            <table style="margin-top: 55px;" id="search-inventory" class="table table-vcenter datatable">
                                <thead>
                                <tr>
                                    <th class="w-1"><a class="table-header">No.</a></th>
										<th><a class="table-header">Date</a></th>
										<th><a class="table-header">Name</a></th>
										<th><a class="table-header">Description</a></th>
										<th><a class="table-header">Supplier</a></th>
										<th><a class="table-header">Amount</a></th>
    ...
    <script>
        $(document).ready(function () {
            new DataTable('#search-inventory', {
                responsive: true,
                autoWidth: false,
                language: {
