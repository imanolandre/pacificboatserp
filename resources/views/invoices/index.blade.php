        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('invoices.create') }}" class="btn btn-primary d-none d-sm-inline-block texto">
                        ...
                        <a href="{{ route('invoices.create') }}" class="btn btn-primary d-sm-none btn-icon">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body border-bottom py-3 table-responsive">
                            <table style="margin-top: 55px;" id="search-invoices" class="table table-vcenter datatable">
                                <thead>
                                <tr>
                                    <th class="w-1"><a class="table-header">No.</a></th>
										...
										<th><a class="table-header">File</a></th>
                                ...
                                @forelse ($invoices as $index => $invoice)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
											...
											<td>{{ $invoice->yacht_name }}</td>
											<td>{{ $invoice->location }}</td>
											<td>{{ $invoice->email }}</td>
											<td>{{ $invoice->date }}</td>
											<td>{{ pathinfo($invoice->file)['filename'] }}</td>
